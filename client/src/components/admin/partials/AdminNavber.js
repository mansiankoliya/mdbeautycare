...
const AdminNavber = (props) => {
  ...
  return (
    <Fragment>
      <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-3 md:px-8 top-0 w-full main-nav bg-white">
        ...
        <div className="hidden lg:block lg:flex lg:items-center lg:space-x-4 mr-32">
          <span>
            <svg
              className="w-8 h-8 cursor-pointer nav-text"
        ...
        <div className="hidden lg:block">
          <span
            ...
            className="flex items-left text-center brand-name  text-2xl cursor-pointer px-2 text-center"
        ...
        <div className="lg:hidden flex items-center">
          ...
          <span
            onClick={(e) => history.push("/admin/dashboard")}
            // style={{ letterSpacing: "0.10rem" }}
            className="flex items-left text-center text-2xl cursor-pointer px-2 text-center brand-name "
          // className="flex items-left text-center font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 text-center"
          >
            M & D Beauty Care
          </span>
          ...
          >
            ...
            <div className="userDropdown absolute right-0 mt-1 bg-gray-200 rounded">
              <li className="flex flex-col text-gray-700">
                ...
                {/* <span className="flex space-x-1 py-2 px-8 hover:bg-gray-400  cursor-pointer" onClick={(e) => history.push("/setting")}>
                  <span>
                    <svg
                      className="w-6 h-6"
                      fill="none"
                ...
                <span
                  onClick={(e) => logout()}
                  className="flex space-x-1 py-2 px-8 hover:bg-gray-400 cursor-pointer nav-icons"
                >
                  <span>
                    <svg
                      className="w-6 h-6"
