      ...
      {/* <div
        ...
        <div
          ...
          className={`${location.pathname === "/admin/dashboard"
              ? "border-r-4 border-pink-800 bg-gray-100"
              : ""
            } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center `}
        >
          <span>
            <svg
              className="w-8 h-8 text-pink-600 hover:text-gray-800"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          <span className="hover:text-pink-800">Dashboard</span>
        </div>
        ...
        >
          ...
          <span className="hover:text-pink-800">Categories</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-pink-800">Product</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-pink-800">Order</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
