...
const Product = () => {
  ...
  return (
    <Fragment>
      ...
      <div className="grid grid-cols-2 md:grid-cols-1 gridclass">
        {products.length > 0 ? (
              ...
              >
                <div className="md:w-1/2 md:flex md:items-center">
                  <img
                    ...
                    className="cursor-pointer md:h-20 md:w-20 object-cover object-center csseffect"
                    src={`${apiURL}/uploads/products/${product.pImages[0]}`}
                    alt="wishListproduct"
                  />
                  <div className="text-lg md:ml-6 truncate colcss">
                    {product.pName}
                  </div>
                </div>
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  <div
                    ...
                    onClick={(e) => history.push(`/products/${product._id}`)}
                    className="inline-block px-4 py-2 text-white text-xs md:text-base text-center cursor-pointer"
                  >
                    View
          ...
          <div style={{color:"red"}}>No product found in wishList</div>
        )}
      </div>
      </div>
    </Fragment>
  ...
  return (
    <Fragment>
      <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
        <div className="text-2xl mx-2 mb-6 wishlistcss had">Wishlist</div>
        {/* Product List */}
        <Product />
      </section>
    </Fragment>
