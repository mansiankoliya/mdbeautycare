        ...
        <div className="shadow-lg border">
          ...
          <div className="py-4 px-4 md:px-8 lg:px-16 flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <input onChange={(e) => setFdata({ ...fData, name: e.target.value })}
                value={fData.name}
                type="text"
                id="name"
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="email" className="inputname">Email</label>
              <input
                value={fData.email}
                readOnly
                type="email"
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="number" className="inputname">Phone Number</label>
              <input onChange={(e) => setFdata({ ...fData, phone: e.target.value })}
                value={fData.phone}
                type="tel"
                id="number"
                autoComplete="off"
