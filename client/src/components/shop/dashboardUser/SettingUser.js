    ...
    <Fragment>
      <div className="flex flex-col w-full my-4 md:my-0 md:w-9/12 md:px-8">
        <div className="shadow-lg border">
          <div className="py-4 px-4 text-lg font-semibold border-t-2 border-black ordcolor">
          ...
          <div className="py-4 px-4 md:px-8 lg:px-16 flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="oldPassword" className="inputname">Old Password</label>
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="newPassword" className="inputname">New Password</label>
              <input
                onChange={(e) =>
            ...
            <div className="flex flex-col space-y-2">
              <label htmlFor="confirmPassword" className="inputname">Confirm Password</label>
              <input
                onChange={(e) =>
