        ...
        >
          <div className="overflow-y-auto">
            <div className="border-b border-gray-700 flex justify-between">
              <div className="p-4 text-lg font-semibold txtcolor">Cart</div>
              {/* Cart Modal Close Button */}
              <div className="p-4 text-white">
                <svg
                  onClick={(e) => cartModalOpen()}
                  className="w-6 h-6 cursor-pointer txtcolor"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            <div className="m-4 flex-col">
              {products &&
                ...
                products.map((item, index) => {
                  return (
                    <Fragment key={index}>
                      {/* Cart Product Start */}
                      <div className="text-white flex space-x-2 my-4 items-center txtcolor">
                        <img
                        ...
                        <div className="relative w-full flex flex-col">
                          <div className="my-2 cartname">{item.pName}</div>
                          ...
                          <div
                            ...
                            className="absolute top-0 right-0 txtcolor"
                          >
                            <svg
              ...
              {products === null && (
                <div className="m-4 flex-col ouantity text-xl text-center">
                  No product in cart
                </div>
              )}
            </div>
          ...
          <div className="m-4 space-y-4">
            <div
              onClick={(e) => cartModalOpen()}
              className="cursor-pointer px-4 py-2 border border-gray-400 text-white text-center cursor-pointer btncolor"
            >
              Continue shopping
            </div>
            {data.cartTotalCost ? (
              <Fragment>
                {isAuthenticate() ? (
                  <div
                    className="px-4 py-2 btncolor text-white text-center cursor-pointer"
                    onClick={(e) => {
              ...
              <div className="px-4 py-2 bg-black text-white text-center cursor-not-allowed btncolor">
                Checkout
              </div>
            )}
          </div>
