...
const ProductDetailsSection = (props) => {
  ...
  return (
    <Fragment>
      ...
      />
      <section className="m-4 md:mx-12 md:my-6 sectioncss">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex justify-between items-center mb-4">
                <svg
                  ...
                  className="flex justify-center  w-12 h-12 text-gray-700 opacity-25 cursor-pointer slidhover hover:opacity-100"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-5 md:ml-6 lg:ml-12">
            <div className="flex flex-col leading-8">
              ...
              <div className="flex justify-between items-center">
                <span className="text-xl tracking-wider colorcss">
                  ₹{sProduct.pPrice}.00
                </span>
                <span>
                  <svg
                    ...
                    className={`${isWish(sProduct._id, wList) && "hidden"
                      } w-5 h-5 md:w-6 md:h-6 cursor-pointer colorcss`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
