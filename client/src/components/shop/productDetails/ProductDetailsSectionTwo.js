    ...
    <Fragment>
      <div className="flex flex-col md:flex-row items-center justify-center ">
        <div
          ...
          className={`${data.menu ? "border-b-2 bod" : ""
            } px-4 py-3 cursor-pointer colorcss`}
        >
          Description
        </div>
        <div
        ...
        >
          <span className="colorcss">Reviews</span>
          <span className="absolute text-xs top-0 right-0 mt-2 text-white rounded px-1 reviwecss">
  ...
  return (
    <Fragment>
      ...
      {isAuthenticate() ? (
        ...
        <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 bg-red-200 px-4 py-2 rounded mb-4 colorcss">
  ...
  return (
    <Fragment>
      ...
      <div className="m-4 md:mx-8 md:my-6 flex justify-center capitalize font-light tracking-widest bg-white border-t border-b text-gray-800 px-4 py-4 space-x-4">
        <div>
          <span className="colorcss">Category :</span>
